...
import com.chatting.config.filter.JWTAuthenFilter;
import com.chatting.config.filter.JWTAuthorFilter;
...
public class SecurityConfig {
	...
	SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.addFilterBefore(new JWTAuthorFilter(memberRepo), AuthorizationFilter.class);
